            ...
            <div class="col-12">
                <div class="footer_left">
                    <!-- <div class="footer_logo">
                        <a href="landing">
                            <img *ngIf="auth.currentUser()" src="assets/newlogowhite.png" alt="Logo">
                        </a>
                    </div> -->
                ...
                <div class="social_icon_footer">
                    <ul>
                        ...
                        <li>
                            <a href="https://www.instagram.com/wondrfly/" target="_blank">
                        ...
                        <li>
                            <a href="https://www.pinterest.com/wondrfly/"  target="_blank"  >
