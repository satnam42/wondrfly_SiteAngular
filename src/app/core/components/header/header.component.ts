        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div>
                    <form class="banner_form" data-toggle="collapse" href="#dropdownprogram-provider" role="button" aria-expanded="false" aria-controls="dropdownprogram-provider">
                        <div class="form-group ">
                            <input type="text" autocomplete="off" (keyup)="searchSubCategory(filterData.activityName);providerSearch(filterData.activityName)"
                        ...
                        <div class="form-group cursor" >
                            <button class="banner_button cursor" type="submit" routerLink="search" (click)="searchActivityByNameDate()">
                                <img src="assets/search_icon.svg" alt="Search image">
                            </button>

                        </div>

                        <div class="dropdownprogram" *ngIf="(categoriesBySearch?.length || providersBySearch?.length ) && filterData.activityName" >
                            <div class="card card-body">
                              <div class="program-list"
                                *ngIf="categoriesBySearch?.length">
                                <h6  (click)="searchBySubCategory(category._id)" *ngFor="let category of categoriesBySearch | slice:0:4">
                                    {{category.name}}
          ...
          <ul *ngIf="isLogin" class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" routerLink="/program/home" [class.active]="insightClass">
                ...
                <span class="icon "><img src="assets/Insights-icon.svg" alt="Logo"></span>
                  Insights
              </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link cursor" [class.active]="helpClass">
                ...
                <span class="icon "><img src="assets/Help-icon.svg" alt="Logo"></span>
                Help
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link cursor" data-toggle="modal" data-target="#NotificationModal">
                ...
                <span class="icon "><img src="assets/Notification-icon.svg" alt="Logo"></span>
                Notifications
              </a>
            </li>
          ...
          <div class="header_right row" [ngClass]="{'after-nav':logoPosition}">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <a class="dropdown-item cursor" (click)="profile()"><img src="assets/profile.svg"> Profile</a>
              <a class="dropdown-item cursor" (click)="logout()"><img src="assets/logout.svg"> Logout</a>
            </div>
              ...
              <a  class="noti-lefticon cursor"  data-toggle="modal" data-target="#NotificationModal">
                <span class="icon rel"><img src="assets/Notification-icon.svg" alt="Logo">
                  <span class="Button-badge" *ngIf='user.notices?.count' >
                    <span *ngIf='user.notices?.count<=10'>{{user.notices?.count}}</span>
                    <span *ngIf='user.notices?.count>10'>{{10}}+</span>
                  </span>
                </span>
              </a>
              <a  class="share-lefticon cursor"  (click)='savedList()'>
                <span class="icon rel"><img src="assets/bookmark_gray.svg" alt="Logo">
                </span>
              </a>
            </div>
    ...
    <div class="modal-content noti_modal">
      ...
      <div class="modal-body N_modal1">
        ...
        <div class="heading_alert">
          Alerts
          <span class="red_dot"><svg width="4" height="4" viewBox="0 0 4 4" fill="none"
              xmlns="http://www.w3.org/2000/svg">
              <circle cx="2" cy="2" r="2" fill="#FA627D" /></svg>
          </span>
          <span class="red_heading_alert"> {{user.notices?.count}} New</span>
          ...
          <span *ngIf="isLogin" (click)="clearAll()">  clear all
          </span>
          </span>
        </div>
        <hr class="grey_line">
        <div class="notification" *ngFor="let notification of user?.notices.notifications; let i =index;">
          <div class="noti_heading">
            ...
            <span class="in_close cursor" (click)="deleteNotification(notification,i)"><svg width="6" height="6" viewBox="0 0 6 6" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path
...
{{notification.description}}</div>
        ...
        <div class="heading_alert info">
          Updates<span class="blue_dot"><svg width="4" height="4" viewBox="0 0 4 4" fill="none" xmlns="http://www.w3.org/2000/svg">
  <circle cx="2" cy="2" r="2" fill="#53B2E8"/>
        ...
        <div class="notification">
          <div class="noti_heading">
            <span class="blue_dot"><svg width="4" height="4" viewBox="0 0 4 4" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <circle cx="2" cy="2" r="2" fill="#53B2E8" />
              </svg>
            </span>
          ...
          <div class="noti_description">
            Neque iaculis neque, gravida est. Tempus, duis quis in ac, placerat morbi purus etiam.
          </div>
        </div>
        <div class="notification">
          <div class="noti_heading">
...
<div class="modal fade verification_modal password" id="review" data-backdrop="static" data-keyboard="false"
    ...
    <div class="modal-dialog modal-dialog-centered review-pop">
        <div class="modal-content popu-ip">
            <button type="button" class="close" id='close_feedback_modal' (click)='cancelFeedback()' data-dismiss="modal" routerLink="/login" aria-label="Close">
                <span aria-hidden="true" class="icon-close"></span>
            </button>
                            ...
                            <div class="tab-pane active" id="parent" role="tabpanel">
                                    ...
                                    <div class="container images-popup">
                                        <div class="row">
                                            <div class="col-4"  (click)="feedbackData.feedback='poor'">
                                                <img  [ngClass]="{'active': feedbackData.feedback==='poor'}" src="assets/smile1.svg">
                                                <!-- <h6>POOR</h6> -->
                                            </div>
                                            <div class="col-4"  (click)="feedbackData.feedback='average'">
                                                <img [ngClass]="{'active': feedbackData.feedback==='average'}" src="assets/smile2.svg">
                                                <!-- <h6 >AVERAGE</h6> -->
                                            </div>
                                            <div class="col-4"  (click)="feedbackData.feedback='great'">
                                                <img [ngClass]="{'active': feedbackData.feedback==='great'}" src="assets/smile3.svg">
                                                <!-- <h6>GREAT</h6> -->
                                            </div>
                                        </div>
                                    </div>
                                    <div class="pop-upbtn">
                                        <div _ngcontent-gvo-c1="" class="input-group-append">
                                            <button _ngcontent-gvo-c1="" [disabled]="!feedbackData.feedback" class="Submit_btn" data-dismiss="modal" type="button" (click)="submitFeedback()">Submit</button>
                                        </div>
                                    </div>
